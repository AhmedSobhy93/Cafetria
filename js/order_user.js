...
var total_price=0;
var btn_id;
$("#image>figure>div>img").on("click",image_click);
console.log($('#image>figure>img'));
...
function image_click(e)
{
    ...
    if(flag==1)
    {
        ...
        flag=0;
        single_price=price_array[image_name];
        amount_price=single_price*final_amount;
        all_order_price_array[index]=amount_price
        $("#row_"+image_id).replaceWith('<tr id="row_'+image_id+'"><td>'+image_name+'</td><td>'+final_amount+'</td><td>'+amount_price+'</td><td><button id="btn_'+image_id+'">cancel</button></td></tr>')
    ...
    else
    {
        ...
        $("#table>tbody").append('<tr id="row_'+image_id+'"><td>'+image_name+'</td><td>'+final_amount+'</td><td>'+amount_price+'</td><td><button id="btn_'+image_id+'">cancel</button></td></tr>');
        $("#btn_"+image_id).on("click",cancel_click);
